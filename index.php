...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            ...
            <li><span>Image 02</span><div><h3>Naples Beach</h3></div></li>
            <li><span>Image 03</span><div><h3>Hotel & Golf Club</h3></div></li>
            <li><span>Image 04</span><div><h3>Naples Beach</h3></div></li>
            <li><span>Image 05</span><div><h3>Hotel & Golf Club</h3></div></li>
            <li><span>Image 06</span><div><h3></h3>Naples Beach</div></li>
        </ul>
        <div class="container">
            <!-- Codrops top bar -->
           <!--  <div class="codrops-top">
            ...
            <header>
                <h1> <span>Naples Beach<br>Hotel & Golf Club</span></h1>
